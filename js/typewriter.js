...
! function(t, s, e) {
    ...
    var r = {
        strings: [`<i class="fa fa-laptop text-muted pr-2"></i> Student at IGNOU`, `I'm a Full stack <i class="fa pl-2 pr-2 fa-code"></i> Developer...`, `I Love <i class="fa fa-heart     text-danger"></i> problem solving and Programming...`],
        stringsElement: null,
        typeSpeed: 0,
        startDelay: 0,
        backSpeed: 0,
